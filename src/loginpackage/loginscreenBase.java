...
public abstract class loginscreenBase extends GridPane {
    ...
    public loginscreenBase() {
        ...
        imageView.setImage(new Image(getClass().getResource("../../../../Downloads/xo.jpg").toExternalForm()));
        ...
        imageView0.setImage(new Image(getClass().getResource("../../../../Downloads/icons8-sign-in-64.png").toExternalForm()));
        ...
        imageView1.setImage(new Image(getClass().getResource("../../../../Downloads/icons8-sign-up-64.png").toExternalForm()));
